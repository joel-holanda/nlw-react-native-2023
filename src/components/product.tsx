...
import { Text, View, Image, ImageProps, TouchableOpacity, TouchableOpacityProps } from "react-native";
        ...
        <TouchableOpacity className="w-full flex-row items-center pb-4" {...rest}>
            ...
            <View className="flex-1 ml-3">
                <View className="flex-row items-center ">
                    ...
                    { data.quantity && <Text className="text-slate-400 text-xs leading-5 mt-0.5">X {data.quantity}</Text> }
                </View>
